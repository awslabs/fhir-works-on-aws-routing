...
describe('FHIRStructureDefinitionRegistry', () => {
    test('getCapabilities snapshot', () => {
        expect(new FHIRStructureDefinitionRegistry(IGCompiledStructureDefinition).getCapabilities()).toMatchInlineSnapshot(`
            Object {
              "Coverage": Object {
    ...
    test('getProfiles snapshot', () => {
        expect(new FHIRStructureDefinitionRegistry(IGCompiledStructureDefinition).getProfiles('Patient')).toMatchInlineSnapshot(`
            Array [
              "http://hl7.org/fhir/us/carin-bb/StructureDefinition/C4BB-Patient",
            ]
        `);
